...
if command -v filezilla &> /dev/null; then
    ...
    cd /tmp
    sudo wget -O filezilla.tar.xz "https://dl2.cdn.filezilla-project.org/client/FileZilla_3.69.3_x86_64-linux-gnu.tar.xz?h=1UOoX_Lj7xb6SdBapVHUMg&x=1757211721"
